#Our favourite Snake game with Basic Graphics. Made this using the turtle module.
#Random shaped food with colors pop up everytime.
#Also it keeps a look on your scores, play with friends and enjoy.
